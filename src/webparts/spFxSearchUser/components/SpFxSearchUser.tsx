...
import styles from './SpFxSearchUser.module.scss';
import { ISpFxSearchUserProps } from './ISpFxSearchUserProps';
...
export default class SpFxSearchUser extends React.Component<ISpFxSearchUserProps, ISearchUserState> {
  constructor(props: ISpFxSearchUserProps, state: ISearchUserState) {
    super(props);
    this.state = {
      users: [],
      searchFor: ''
  ...
  public render(): React.ReactElement<ISpFxSearchUserProps> {
    return (
      <div className={ styles.spFxSearchUser }>
